...
import com.a65apps.architecturecomponents.sample.domain.sample.SampleInteractor;
...
@InjectViewState
public class SamplePresenter extends MoxyPresenter<SampleState, MoxyView<SampleState>, SampleInteractor,
        Router> {
