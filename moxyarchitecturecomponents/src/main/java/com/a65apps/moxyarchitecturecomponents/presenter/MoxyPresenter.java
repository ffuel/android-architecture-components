...
@NotThreadSafe
public abstract class MoxyPresenter<S extends State, V extends MoxyView<S>, I extends Interactor<S, R>,
        R extends Router> extends MvpPresenter<V> implements Presenter<S, V, I, R> {
    ...
    public MoxyPresenter(@NonNull ExecutorsFactory executors, @NonNull I interactor,
